-- ============================================================================
-- Patch: Fix reset_action_plans_safe to clear drop_requests + is_drop_pending
-- ============================================================================
...
BEGIN
  ...
  SET
    ...
    reviewed_at = NULL,
    -- Carry-over fields
    carry_over_status = NULL, -- Clear legacy status
  ...
  RETURN jsonb_build_object(
    ...
    'message', 'Safe Reset Complete: Pruned copies and reset masters.'
  );
END;
$$;
