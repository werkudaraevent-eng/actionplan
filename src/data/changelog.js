...
export const CHANGELOG = [
  ...
  },
  {
    ...
    changes: [
      ...
      { type: 'fix', description: 'Panel penutupan bulan ikut mematuhi batasan divisi. Sebelumnya leader yang sudah dibatasi masih melihat nama divisi lain beserta jumlah plannya, dan tombol Tutup Bulan menawarkan mengirim seluruh plan departemen — termasuk milik divisi tetangga' },
      { type: 'security', description: 'Leader yang dibatasi ke divisinya tidak bisa menutup bulan untuk seluruh departemen, ditolak di server bukan sekadar disembunyikan tombolnya. Ia menandai divisinya siap, keputusan menutup departemen tetap di tangan kepala departemen' },
      { type: 'feature', description: 'Status Ketua Divisi bisa ditetapkan langsung dari form user di Team Management — sebelumnya hanya lewat Admin Settings, jauh dari halaman tempat orang dikelola. Ketua divisi inilah yang berwenang menandai divisinya siap saat penutupan bulan' },
