...
import { clearPermissionCache, PERMISSION_RULES, getPermissionRule } from '../hooks/usePermission';
                    ...
                    {config.actions.map((action, actionIndex) => {
                      ...
                      return (
                        <tr
                          ...
                          className={`hover:bg-gray-50 transition-colors ${isLastInCategory ? 'border-b border-gray-200' : ''
                            }`}
                        >
                            ...
                            return (
                              <td key={role.key} className="px-4 py-3 text-center">
                                {isLocked ? (
                                  ...
                                  <div
                                    className={`inline-flex items-center justify-center w-12 h-7 rounded-full ${isLockedOn
                                  ...
                                  <button
                                    ...
                                    className={`relative inline-flex items-center justify-center w-12 h-7 rounded-full transition-all ${isAllowed
                                  ...
                                  >
                                    <span
                                      className={`absolute w-5 h-5 bg-white rounded-full shadow transition-transform ${isAllowed ? 'translate-x-2.5' : '-translate-x-2.5'
                                        }`}
                                    >
                                      {isAllowed ? (
